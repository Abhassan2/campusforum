  ...
  return (
    ...
    >
      <div className="grid">
        ...
        { Array.isArray(memoizedComments) && memoizedComments?.length === 0 ? (
          <NoComments />
        ) : (
          <VirtuosoGrid
            style={{ height: "100vh" }}
            totalCount={memoizedComments?.length}
            itemContent={(index) => (
              <CommentCard key={memoizedComments[index]._id} comment={memoizedComments[index]} />
            )}
